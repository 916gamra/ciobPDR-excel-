/**
 * HubIcon - Google Material Symbols "hub" icon
 * 100% Offline SVG component
 * Represents Machine Families (Familles de Machines & Composants)
 */
...
export const Hub = HubIcon;
export const FamilyIcon = HubIcon;
