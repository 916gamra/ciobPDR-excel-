...
import {       Layers, Plus, Search, ArrowRight, FolderTree, Cpu, Trash2, Edit2, AlertTriangle , ChevronLeft , ChevronRight , SlidersHorizontal , ArrowUpDown , ChevronDown , ArrowDown, ArrowUp } from 'lucide-react';
    ...
    <AnimatedPage className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-xs flex items-center justify-between">
          <div>
            <div className="text-[10.5px] font-bold text-slate-500 uppercase tracking-wider">Formule C (Famille Parente)</div>
        ...
        <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-xs flex items-center justify-between">
          <div>
            <div className="text-[10.5px] font-bold text-slate-500 uppercase tracking-wider">Formule D (Nb Machines)</div>
        ...
        <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-xs flex items-center justify-between">
          <div>
            <div className="text-[10.5px] font-bold text-slate-500 uppercase tracking-wider">Formule En Service</div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-100">
          ...
          <div className="flex items-center gap-3">
            <div className="text-xs font-semibold text-slate-500">
              <span className="bg-amber-50 text-amber-800 px-2.5 py-1 rounded-lg font-bold border border-amber-100">
          ...
          <div className="w-full">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-10 pl-9 pr-3 rounded-xl border border-slate-200 bg-slate-50 text-xs focus:bg-white focus:outline-none focus:ring-1 focus:ring-amber-500"
              />
            </div>
          </div>
            ...
            <button
              ...
              className={`w-full h-10 px-3 rounded-xl border text-xs font-semibold transition flex items-center justify-between cursor-pointer ${
                showSortMenu || sortField !== 'id_templates' || sortOrder !== 'asc'
                  ? 'bg-amber-50 text-amber-800 border-amber-300 ring-1 ring-amber-200 shadow-2xs' : 'bg-slate-50 text-slate-700 border-slate-200 hover:bg-slate-100'}`}
            >
              <div className="flex items-center gap-2">
              ...
              <div className="absolute left-0 right-0 mt-2 bg-white rounded-2xl border border-slate-200 shadow-xl z-50 p-3 space-y-2 animate-in fade-in slide-in-from-top-2 duration-150">
                ...
                <div className="grid grid-cols-1 gap-1 text-xs">
                  ...
                  >
                    <span>Modèle (ID)</span>
                    {sortField === 'id_templates' && (
                      sortOrder === 'asc' ? <ArrowUp className="w-3 h-3 text-amber-600 shrink-0" /> : <ArrowDown className="w-3 h-3 text-amber-600 shrink-0" />
                    )}
                  </button>
