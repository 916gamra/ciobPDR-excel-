export class Blueprint {
  ...
  // Method: Tab1 - Law - Are specs identical?
  isSameSpecs(other) {
  ...
  // Method: Tab2,3,4 - Are BOMs identical? - Twins = same Blueprint
  isTwin(other) {
  ...
  // Method: Nexus Extraction Engine - Extract Tab2,3,4 from real machine life
